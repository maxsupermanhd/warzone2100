...
macro(_gitRepo)
	...
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!#")
	message(STATUS "# Using 4.1.2 VCS info #")
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!#")
	set(VCS_TYPE "git")
	set(VCS_BASENAME "warzone2100")
	set(VCS_BRANCH "")
	set(VCS_TAG "4.1.3")
	set(VCS_TAG_TAG_COUNT "62")
	set(VCS_EXTRA "4.1.3")
	set(VCS_FULL_HASH "5d02c7f6085c502524d099efc3d526cdd143a780")
	set(VCS_SHORT_HASH "5d02c7f")
	set(VCS_WC_MODIFIED "0")
	set(VCS_REPO_IS_SHALLOW "0")
	set(VCS_COMMIT_COUNT "17075")
	set(VCS_MOST_RECENT_TAGGED_VERSION "4.1.3")
	set(VCS_MOST_RECENT_TAGGED_VERSION_TAG_COUNT "62")
	set(VCS_COMMIT_COUNT_SINCE_MOST_RECENT_TAGGED_VERSION "0")
	set(VCS_COMMIT_COUNT_ON_MASTER_UNTIL_BRANCH "17075")
	set(VCS_BRANCH_COMMIT_COUNT "0")
	set(VCS_MOST_RECENT_COMMIT_DATE "2021-08-09")

...
macro(_gitRepo)
	...
	message("#=!=!=!=!=!=!=!=!=!=!=!#")
	message("# Using 4.0.1 VCS info #")
	message("#=!=!=!=!=!=!=!=!=!=!=!#")
	set(VCS_TYPE "git")
	set(VCS_BASENAME "warzone2100")
	set(VCS_BRANCH "")
	set(VCS_TAG "4.0.1")
	set(VCS_TAG_TAG_COUNT "57")
	set(VCS_EXTRA "4.0.1")
	set(VCS_FULL_HASH "3a3c652d96e5ce4827200d64d3d042a0f380a39e")
	set(VCS_SHORT_HASH "3a3c652")
	set(VCS_WC_MODIFIED "0")
	set(VCS_REPO_IS_SHALLOW "0")
	set(VCS_COMMIT_COUNT "16560")
	set(VCS_MOST_RECENT_TAGGED_VERSION "4.0.1")
	set(VCS_MOST_RECENT_TAGGED_VERSION_TAG_COUNT "57")
	set(VCS_COMMIT_COUNT_SINCE_MOST_RECENT_TAGGED_VERSION "0")
	set(VCS_COMMIT_COUNT_ON_MASTER_UNTIL_BRANCH "16560")
	set(VCS_BRANCH_COMMIT_COUNT "0")
	set(VCS_MOST_RECENT_COMMIT_DATE "2021-04-18")

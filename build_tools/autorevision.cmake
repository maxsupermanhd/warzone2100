...
macro(_gitRepo)
	...
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!#")
	message(STATUS "# Using 4.1.1 VCS info #")
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!#")
	set(VCS_TYPE "git")
	set(VCS_BASENAME "warzone2100")
	set(VCS_BRANCH "")
	set(VCS_TAG "4.1.1")
	set(VCS_TAG_TAG_COUNT "60")
	set(VCS_EXTRA "4.1.1")
	set(VCS_FULL_HASH "b86506c56dc244d4fc8da7d1ac236db7faf03437")
	set(VCS_SHORT_HASH "b86506c")
	set(VCS_WC_MODIFIED "0")
	set(VCS_REPO_IS_SHALLOW "0")
	set(VCS_COMMIT_COUNT "17006")
	set(VCS_MOST_RECENT_TAGGED_VERSION "4.1.1")
	set(VCS_MOST_RECENT_TAGGED_VERSION_TAG_COUNT "60")
	set(VCS_COMMIT_COUNT_SINCE_MOST_RECENT_TAGGED_VERSION "0")
	set(VCS_COMMIT_COUNT_ON_MASTER_UNTIL_BRANCH "17006")
	set(VCS_BRANCH_COMMIT_COUNT "0")
	set(VCS_MOST_RECENT_COMMIT_DATE "2021-07-25")

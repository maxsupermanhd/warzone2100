...
macro(_gitRepo)
	...
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!#")
	message(STATUS "# Using 4.1.0 VCS info #")
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!#")
	set(VCS_TYPE "git")
	set(VCS_BASENAME "warzone2100")
	set(VCS_BRANCH "")
	set(VCS_TAG "4.1.0")
	set(VCS_TAG_TAG_COUNT "59")
	set(VCS_EXTRA "4.1.0")
	set(VCS_FULL_HASH "046c2f9891825cc60cec712e6249b17cba33422d")
	set(VCS_SHORT_HASH "046c2f9")
	set(VCS_WC_MODIFIED "0")
	set(VCS_REPO_IS_SHALLOW "0")
	set(VCS_COMMIT_COUNT "16940")
	set(VCS_MOST_RECENT_TAGGED_VERSION "4.1.0")
	set(VCS_MOST_RECENT_TAGGED_VERSION_TAG_COUNT "59")
	set(VCS_COMMIT_COUNT_SINCE_MOST_RECENT_TAGGED_VERSION "0")
	set(VCS_COMMIT_COUNT_ON_MASTER_UNTIL_BRANCH "16940")
	set(VCS_BRANCH_COMMIT_COUNT "0")
	set(VCS_MOST_RECENT_COMMIT_DATE "2021-07-04")

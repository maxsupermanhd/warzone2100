...
macro(_gitRepo)
	...
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!=!=!=#")
	message(STATUS "# Using 4.1.0beta1 VCS info #")
	message(STATUS "#=!=!=!=!=!=!=!=!=!=!=!=!=!=#")
	set(VCS_TYPE "git")
	set(VCS_BASENAME "warzone2100")
	set(VCS_BRANCH "")
	set(VCS_TAG "4.1.0-beta1")
	set(VCS_TAG_TAG_COUNT "58")
	set(VCS_EXTRA "4.1.0-beta1")
	set(VCS_FULL_HASH "44fae38481a7f9d728a3e1164398f457946e2321")
	set(VCS_SHORT_HASH "44fae38")
	set(VCS_WC_MODIFIED "0")
	set(VCS_REPO_IS_SHALLOW "0")
	set(VCS_COMMIT_COUNT "16871")
	set(VCS_MOST_RECENT_TAGGED_VERSION "4.1.0-beta1")
	set(VCS_MOST_RECENT_TAGGED_VERSION_TAG_COUNT "58")
	set(VCS_COMMIT_COUNT_SINCE_MOST_RECENT_TAGGED_VERSION "0")
	set(VCS_COMMIT_COUNT_ON_MASTER_UNTIL_BRANCH "16871")
	set(VCS_BRANCH_COMMIT_COUNT "0")
	set(VCS_MOST_RECENT_COMMIT_DATE "2021-06-18")
	set(VCS_MOST_RECENT_COMMIT_YEAR "2021")
